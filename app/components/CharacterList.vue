  ...
  <div v-if="characters.length > 0">
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-2 gap-x-4 gap-y-2.5">
      <div
        ...
        @click="preview = char"
      >
        <img :src="char.imageUrl" :alt="char.name" class="w-10 h-10 rounded-full object-cover flex-shrink-0">
        <div class="min-w-0">
    ...
    >
      <div class="relative max-w-xs w-full mx-4 animate-in fade-in zoom-in-95 duration-200 cursor-default" @click.stop>
        <div class="relative w-full aspect-[3/4]">
          <img :src="preview.imageUrl" :alt="preview.name" class="rounded-xl object-cover shadow-2xl w-full h-full">
        </div>
